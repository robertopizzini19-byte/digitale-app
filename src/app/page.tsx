...
function BrandLogo({ size = "default", variant = "dark" }: { size?: "sm" | "default" | "lg"; variant?: "dark" | "light" }) {
  const cfg = {
          ...
          <div className="lg:hidden border-t border-border/60 bg-white">
            <div className="flex flex-col px-5 py-4 gap-1">
              ...
              <div className="mt-3 pt-3 border-t border-border/60 flex flex-col gap-2">
                <Link href="/dashboard" className="text-center px-4 py-3 rounded-xl text-[15px] font-medium text-dark hover:bg-gray-50 transition-colors">Accedi</Link>
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 py-16">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            &copy; 2025 DigiITAle &mdash; Fatto in Italia, per l&apos;Italia. Tutti i diritti riservati.
          </p>
        ...
        <div className="relative max-w-5xl mx-auto px-5 sm:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              { value: "€0,99", label: "Piano Base", sub: "al mese" },
            ].map((n) => (
